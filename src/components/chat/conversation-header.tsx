...
import { AddUserToChannelModal } from "@components/modals/add-user-to-channel";
...
export function ConversationHeader({
  ...
  const isChannel = safeConversation.type === ConversationType.CHANNEL;
    ...
    <div className="border-b p-3 flex items-center justify-between bg-white shadow-sm">
      ...
      <div className="flex items-center gap-1">
        ...
        {isChannel && (
          ...
          >
            <UserPlus className="h-4.5 w-4.5 text-gray-600" />
          </Button>
        )}
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
          ...
          <DropdownMenuContent align="end" className="w-56">
            ...
            {isChannel && (
              <DropdownMenuItem
                ...
                onClick={() => setIsAddUserModalOpen(true)}
              >
                <UserPlus className="h-4 w-4" /> Add user to channel
              </DropdownMenuItem>
            )}
            <DropdownMenuSeparator />
            <DropdownMenuItem className="gap-2">
