        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
          ...
          {attachments.length > 0 && (
            <div className="flex flex-wrap gap-2 mb-2">
              {attachments.map((file, index) => (
                <div key={index} className="flex items-center bg-muted p-1 rounded-md text-xs">
          ...
          <div className="flex items-end gap-2">
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex-1">
                  <FormControl>
                    <Textarea placeholder="Type your message..." className="resize-none min-h-[80px]" {...field} />
                  </FormControl>
                </FormItem>
              )}
            />
            ...
            <div className="flex gap-2">
              ...
              <Button type="button" variant="outline" size="icon" onClick={handleFileSelect} disabled={isLoading}>
